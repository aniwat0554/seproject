...
//                    play(v);
        ...
        fileview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(in);*/
                Intent in = new Intent(getApplicationContext(), testrecord.class);
                startActivity(in);
            }
        });
...
//test
    ...
    private void setButtonHandlers() {
        ((Button) findViewById(R.id.buttonrecordtest)).setOnClickListener(btnClick);
        ((Button) findViewById(R.id.buttonrecordstop)).setOnClickListener(btnClick);
    }
    ...
    private void enableButtons(boolean isRecording) {
        enableButton(R.id.buttonrecordtest, !isRecording);
        enableButton(R.id.buttonrecordstop, isRecording);
    }
